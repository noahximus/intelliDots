# Generated by Powerlevel10k configuration wizard on 2024-09-05 at 18:41 PST.
...
# 24h time, 2 lines, solid, full frame, blue-ornaments, sparse, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_CONTENT_EXPANSION='${${${VIRTUAL_ENV_PROMPT#\(}%\) }:-${${${VIRTUAL_ENV:t}:#.venv}:-${VIRTUAL_ENV:h:t}}}'
