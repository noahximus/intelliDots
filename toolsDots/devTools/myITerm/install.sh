...
Installs iTerm2 and its profile assets. The essential Brewfile is the default;
--full is accepted for a consistent component interface and currently installs
...
echo "myITerm installed. Restart iTerm2 to load the tracked preferences."
